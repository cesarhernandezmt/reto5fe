function traerInformacion(){
    ...
    $.ajax({
        url:"http://129.151.121.62:8082/api/Admin/all",
        type:"GET",
        datatype:"JSON",
...
function guardarElemento(){
    ...
    if($("#name").val() == "" || $("#email").val() == "" || $("#password").val() == ""){
        ...
        $.ajax({
            url:"http://129.151.121.62:8082/api/Admin/save",
            type:"POST",
            data:dataToSend,
            datatype:"JSON",
            contentType: "application/json",
...
function editarElemento(idElemento){
    ...
    if($("#name").val() == "" || $("#email").val() == "" || $("#password").val() == ""){
        ...
        $.ajax({
            url:"http://129.151.121.62:8082/api/Admin/update",
            type:"PUT",
            data:dataToSend,
            contentType:"application/JSON",
            datatype:"JSON",
...
function borrarElemento(idElemento){
    ...
    $.ajax({
        url:"http://129.151.121.62:8082/api/Admin/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        datatype:"JSON",
        contentType:"application/JSON",
