function traerInformacion(){
    ...
    $.ajax({
        url:"http://129.151.121.62:8082/api/Specialty/all",
        type:"GET",
        datatype:"JSON",
...
function guardarElemento(){
    ...
    if($("#name").val() == "" || $("#description").val() == ""){
        ...
        $.ajax({
            url:"http://129.151.121.62:8082/api/Specialty/save",
            type:"POST",
            data:dataToSend,
            datatype:"JSON",
            contentType: "application/json",
...
function editarElemento(idElemento){
    ...
    if($("#name").val() == "" || $("#description").val() == ""){
        ...
        $.ajax({
            url:"http://129.151.121.62:8082/api/Specialty/update",
            type:"PUT",
            data:dataToSend,
            contentType:"application/JSON",
            datatype:"JSON",
...
function borrarElemento(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://129.151.121.62:8082/api/Specialty/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        datatype:"JSON",
        contentType:"application/JSON",
